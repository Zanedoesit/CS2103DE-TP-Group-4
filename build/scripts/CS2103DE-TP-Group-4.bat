...
@rem ##########################################################################
@rem
@rem  CS2103DE-TP-Group-4 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and C_S2103_DE_TP_GROUP_4_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %C_S2103_DE_TP_GROUP_4_OPTS%  -classpath "%CLASSPATH%" Launcher %*
...
:fail
rem Set variable C_S2103_DE_TP_GROUP_4_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%C_S2103_DE_TP_GROUP_4_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
